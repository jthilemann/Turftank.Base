report 70310 "TURFStandard Sales - Quote"
{
    Caption = 'Sales - Quote';
    RDLCLayout = './src/report/layouts/StandardSalesQuote.rdlc';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(ShippingAgentCode_Header; "Shipping Agent Code")
            {
            }
            column(ShippingAgentServiceCode_Header; "Shipping Agent Service Code")
            {
            }
            column(ShippingAgentCode_Header_Cpt; Fieldcaption("Shipping Agent Code"))
            {
            }
            column(ShippingAgentServiceCode_Header_Cpt; FieldCaption("Shipping Agent Service Code"))
            {
            }
            column(Line_Discount_Pct_Cpt; Line.FieldCaption("Line Discount %"))
            {
            }
