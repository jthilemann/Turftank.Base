// report 70311 "TURFSales - Order Conf."
// {
//     Caption = 'Sales - Confirmation';
//     PreviewMode = PrintLayout;
//     RDLCLayout = './src/report/layouts/TURFSalesOrderConf.rdlc';
//     dataset
//     {
...
//             {
//             }
//             column(Shipping_Agent_Code_Lbl; ShippingAgentLbl)
//             {
//             }
//             column(Shipping_Agent_Service_Code; "Shipping Agent Service Code")
//             {
//             }
//             column(Shipping_Agent_Service_Code_Lbl; ShippingAgentServiceLbl)
//             {
//             }
//             column(TURFOrderType_Header; "TURFOrder Type")
//             {
//             }
...
//                    (CurrReport.UseRequestPage and ArchiveDocumentGV or
//                     not CurrReport.UseRequestPage and SalesSetup."Archive Orders")
//                 then
//                     ArchiveManagement.StoreSalesDocument(Header, LogInteractionGV);
...
//                 {
//                     Caption = 'Options';
//                     field(LogInteraction; LogInteractionGV)
//                     {
...
//                     }
//                     field(ArchiveDocument; ArchiveDocumentGV)
//                     {
//                         ApplicationArea = Basic, Suite;
...
//                         trigger OnValidate()
//                         begin
//                             if not ArchiveDocumentGV then
//                                 LogInteractionGV := false;
//                         end;
//                     }
//                 }
//             }
...
//             ArchiveDocumentGV := SalesSetup."Archive Orders";
//         end;

//         trigger OnOpenPage()
//         begin
//             InitLogInteraction();
//             LogInteractionEnable := LogInteractionGV;
//         end;
//     }
//     labels
//     {
...
//     begin
//         if LogInteractionGV and not IsReportInPreviewMode() then
...
//         ArchiveDocumentGV: Boolean;
//         DisplayAssemblyInformation: Boolean;
//         LogInteractionGV: Boolean;
...
//     begin
//         LogInteractionGV := SegManagement.FindInteractionTemplateCode(Enum::"Interaction Log Entry Document Type"::"Sales Ord. Cnfrmn.") <> '';
//     end;
...
//     begin
//         LogInteractionGV := NewLogInteraction;
