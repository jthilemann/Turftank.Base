report 70302 "TURFPurchase Order"
{
    RDLCLayout = './src/report/layouts/PurchaseOrder.rdlc';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(PurchaseOrderText; DocumentTitleLbl)
            {
            }
            ...
            column(ItemNoCpn; ItemNumberCaptionLbl)
            {
            }
            column(PricesIncVAT_PurchInvHeader; "Purchase Header"."Prices Including VAT")
            {
            }
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                column(UnitPrice_PurchLine; "Unit Cost")
                {
                }
                ...
                column(PurchLineDesc2; "Description 2")
                {
                }
                ...
                begin
                    ...
                    if PurchLine.Find('-') then begin
                        VATAmountText := StrSubstNo(Text011, PurchLine."VAT %");
                        VATIdentifier := PurchLine."VAT Identifier";
                        repeat
                            if (PurchLine."VAT Identifier" <> VATIdentifier) and (PurchLine.Quantity <> 0) then VATAmountText := Text012;
            ...
            begin
                ...
                HeaderLine[3] := HeaderLine3Lbl;
                HeaderLine[4] := HeaderLine4Lbl;
                HeaderLine[5] := HeaderLine5Lbl;
                HeaderLine[6] := HeaderLine6Lbl;
                HeaderLine[7] := HeaderLine7Lbl;
            end;
        }
    }
    requestpage
    ...
    var
        ...
        ItemLineAmountCaptionLbl: Label 'Amount';
        ...
        RequestedReceiptDateLbl: Label 'Requested Delivery Date';
        ExpectedReceiptDateLbl: Label 'Expected Receipt Date';
        PlannedReceiptDateLbl: Label 'Planned Receipt Date';
        PurchOrderNoLbl: Label 'Purchase order';
        FooterTxt: Label 'All purchase orders must be confirmed within 3 working days';
        HeaderLine1Lbl: Label 'Purchase order:';
        HeaderLine2Lbl: Label 'Date:';
        HeaderLine3Lbl: Label 'Our Ref.:';
        HeaderLine4Lbl: Label 'YourRef.:';
        HeaderLine5Lbl: Label 'Supplier ID:';
        HeaderLine6Lbl: Label 'Payment terms:';
        HeaderLine7Lbl: Label 'Delivery terms:';
        ...
        if country.get(CompanyInfo."Country/Region Code") then begin
            ...
            repeat
                ...
                if CompanyAddr[i] = '' then begin
                    if CountryTranslation.get(Country.Code, PurchaseHeader."Language Code") then
                        CompanyAddr[i] := CountryTranslation.Name
                    else
