report 70303 "TURFReminder"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/layouts/Reminder.rdlc';
    Caption = 'Reminder';
        ...
        dataitem("Issued Reminder Header"; "Issued Reminder Header")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                dataitem(VATClauseEntryCounter; "Integer")
                {
                    ...
                    begin
                        TempVATAmountLine.GetLine(Number);
                        if not VATClause.Get(TempVATAmountLine."VAT Clause Code") then CurrReport.Skip();
                ...
                dataitem(VATCounterLCY; "Integer")
                {
                    ...
                    trigger OnPreDataItem()
                    begin
                        if (not GLSetup."Print VAT specification in LCY") or ("Issued Reminder Header"."Currency Code" = '') or (TempVATAmountLine.GetTotalVATAmount() = 0) then CurrReport.Break();
                        SetRange(Number, 1, TempVATAmountLine.Count);
                        VALVATBaseLCY := 0;
                        VALVATAmountLCY := 0;
